  ...
  <div class="site-wrap">
    ...
    <div class="site-navbar py-2">
      ...
      <div class="container">
        <div class="d-flex align-items-center justify-content-between">
          <div class="logo">
            <div class="site-logo">
              <a href="index.php" class="js-logo-clone">Dermo | Eczane</a>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <strong class="text-black">Kayıt Ol</strong>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-5 text-black">Kayıt Ol</h2>
          </div>
          <div class="col-md-12">
    
            <form action="islem.php" method="post" class="contactForm ">
              ...
              <div class="p-3 p-lg-5 border">
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control"  name="soyad" placeholder="...">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_email" class="text-black">Emailiniz <span class="text-danger">*</span></label>
                    <input type="email" class="form-control"  name="email" placeholder="...">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_subject" class="text-black">Şifreniz </label>
                ...
                <div class="col-lg-4"></div>
                  <div class="col-lg-4">
                    <input type="submit" name ="kaydet" class="btn btn-primary btn-lg btn-block" value="Kayıt Ol">
                  </div>
                </div>
              </div>
            </form>
