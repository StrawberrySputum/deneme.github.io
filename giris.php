  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <strong class="text-black">Giriş Yap</strong>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-5 text-black">Giriş Yap</h2>
          </div>
          <div class="col-md-12">
            ...
            <form action="islem.php" method="post" class="contactForm ">
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <div class="col-lg-4"></div>
                  <div class="col-lg-4">
                    <input type="submit" name ="giris" class="btn btn-primary btn-lg btn-block" value="Giriş yap">
                  </div>
                </div>
              </div>
            </form>
