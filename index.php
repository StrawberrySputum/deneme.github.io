    ...
    <div class="site-navbar py-2">
      ...
      <div class="container">
        <div class="d-flex align-items-center justify-content-between">
          <div class="logo">
            <div class="site-logo">
              <a href="index.php" class="js-logo-clone">Dermo | Evim</a>
            </div>
          </div>
          ...
          <a href="giris.php" class="icons-btn d-inline-block ">Giriş Yap</a>
            |
            <a href="kayit.php" class="icons-btn d-inline-block ">Kayıt Ol</a>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-lg-7 mx-auto order-lg-2 align-self-center">
            <div class="site-block-cover-content text-center">
              ...
              <p>
                ...
                <a href="giris.php" class="btn banner-wrap text-light px-5 py-3">Giriş Yap</a>
              </p>
            </div>
          </div>
        </div>
