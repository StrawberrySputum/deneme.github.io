...
<head>
  <title>Dermo &mdash; Eczane</title>
  <meta charset="utf-8">
...
<body>
  ...
  <div class="site-wrap">
          ...
          <div class="main-nav d-none d-lg-block">
            <nav class="site-navigation text-right text-md-center" role="navigation">
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                ...
                <li class="active"><a href="shop.php">Mağaza</a></li>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index2.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Mağaza</strong></div>
        </div>
      </div>
    </div>
    ...
    <div class="site-section">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h3 class="mb-3 h6 text-uppercase text-black d-block">Filtrele</h3>
          ...
          <div class="col-lg-6">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuReference">
              <a class="dropdown-item" href="#">Öncelik</a>
              <a class="dropdown-item" href="#">A'dan Z'ye</a>
              <a class="dropdown-item" href="#">Z'den A'ya</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="#">Fiyat, Önce Yüksek</a>
              <a class="dropdown-item" href="#">Price, Önce Düşük</a>
            </div>
          </div>
        </div>
